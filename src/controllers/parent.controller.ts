...
export const aiAssistantQuery = async (
  ...
  try {
    ...
    const systemPrompt = 'You are a helpful AI assistant for parents, specializing in child education, homework help, school progress, and parenting advice related to learning.'
